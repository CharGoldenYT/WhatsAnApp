...
If you're using Windows, all you need is WebView2 which is built in. If you somehow don't have WebView2, the link is here: [Download WebView2 here](https://developer.microsoft.com/en-us/microsoft-edge/webview2?form=MA13LH#download) (Confirmed by ???)

If you're using MacOS, you don't need any libraries to open the app. Just open the app and it'll launch with no problems at all. (Confirmed by [@TK50P](https://github.com/tk50p))
...
In Windows, here are the steps: (Not yet tested.)
```powershell
git clone https://github.com/daveberrys/WhatsAnApp/
cd WhatsAnApp
rd /s /q .git
